...
import kotlinx.android.synthetic.main.fragment_asalto.*
...
class AsaltoFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(title: String, color: Int): AsaltoFragment {
            val fragment: AsaltoFragment = AsaltoFragment()
    ...
    fun cargar_celdas() {
        ...
        val ll_principal = asalto_layout_a_construir
    ...
    fun cargar_datos(listaArmas: MutableList<Arma>) {
        val subfusil1_stinger = Arma(6, "Stinger",
            "https://i.gyazo.com/7d0c53cbb82852a5687871e201013200.png",
            "Subfusil", "1000",
            listOf("67", "27", "23"), listOf("62", "25", "21"), listOf("62", "25", "21"))

        val subfusil2_spectre = Arma(7, "Spectre",
            "https://i.gyazo.com/07d0901476eaf2e390c8009576788e80.png",
            "Subfusil", "1600",
            listOf("78", "26", "22"), listOf("66", "22", "18"), listOf("66", "22", "18"))

        val escopeta1_bucky = Arma(8, "Bucky",
            "https://i.gyazo.com/da66a7149409aa5240c6bb2743954723.png",
            "Escopeta", "900",
            listOf("44", "22", "19"), listOf("34", "17", "14"), listOf("18", "9", "8"))

        val escopeta2_judge = Arma(9, "Judge",
            "https://i.gyazo.com/f65d7a390c776bbed07c6e7f13e65f7f.png",
            "Escopeta", "1500",
            listOf("34", "17", "14"), listOf("26", "13", "11"), listOf("20", "10", "9"))

        val ametralladoraLigera1_ares = Arma(10, "Ares",
            "https://i.gyazo.com/4fbec253baaa68cb827cfc12bf295778.png",
            "Ametralladora Ligera", "1700",
            listOf("72", "30", "25"), listOf("67", "28", "23"), listOf("67", "28", "23"))

        val ametralladoraLigera2_odin = Arma(11, "Odin",
            "https://i.gyazo.com/d74e822888bfed041302dd06b43b40d2.png",
            "Ametralladora Ligera", "3200",
            listOf("95", "38", "32"), listOf("77", "31", "26"), listOf("77", "31", "26"))

        listaArmas.add(subfusil1_stinger)
        listaArmas.add(subfusil2_spectre)
        listaArmas.add(escopeta1_bucky)
        listaArmas.add(escopeta2_judge)
        listaArmas.add(ametralladoraLigera1_ares)
        listaArmas.add(ametralladoraLigera2_odin)
